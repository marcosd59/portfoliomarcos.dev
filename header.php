...
<header>
	<nav class="navbar navbar-expand-lg navbar-light w-100 flex-nowrap z-999 p-0">
		...
		<div class="container py-3 px-0">
			<a class="navbar-brand d-flex main-logo align-items-center ms-lg-0 ms-md-5 ms-3" href="index.html">
				<img src="assets/imgs/template/favicon-1.svg" alt="zelio">
				<span class="fs-4 ms-2">marcos.dev</span>
			</a>
			...
			<div class="navbar-social d-flex align-items-center pe-5 pe-lg-0 me-5 me-lg-0">
				<div class="d-md-flex d-none gap-3">
					...
					<a href="http://github.com/marcosd59">
	...
	<div class="offCanvas__info">
		...
		<div class="offCanvas__logo mb-5">
			<h3 class="mb-0">Ponte en contacto</h3>
		</div>
		<div class="offCanvas__side-info mb-30">
			<div class="contact-list mb-30">
				<p class="fs-6 fw-medium text-200 mb-5">Siempre estoy entusiasmado por asumir nuevos proyectos y
					colaborar con mentes innovadoras.</p>
				<div class="mb-3">
					<span class="text-400 fs-5">Correo electrónico</span>
					<p class="mb-0">damian.marcospool@gmail.com</p>
				</div>
				<div class="mb-3">
					<span class="text-400 fs-5">LinkedIn</span>
					<p class="mb-0"><a href="https://www.linkedin.com/in/marcosd59"
							target="_blank">linkedin.com/in/marcosd59</a></p>
				</div>
				<div class="mb-3">
					<span class="text-400 fs-5">GitHub</span>
					<p class="mb-0"><a href="https://github.com/marcosd59" target="_blank">github.com/marcosd59</a></p>
				</div>
				<div class="mb-3">
					<span class="text-400 fs-5">Dirección</span>
					<p class="mb-0">Cancún Quintana Roo, México</p>
				</div>
			</div>
		...
		<div class="mobile-header-wrapper-inner">
			<div class="mobile-header-logo">
				<a class="d-flex main-logo align-items-center d-inline-flex" href="index.html">
					...
					<span class="fs-4 ms-2 text-dark">marcos.dev</span>
				</a>
				<div class="burger-icon burger-icon-white border rounded-3">
					<span class="burger-icon-top"></span>
					<span class="burger-icon-mid"></span>
